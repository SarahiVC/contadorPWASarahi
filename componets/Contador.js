...
const Contador = ()=>{
    ...
    return(
        <div>
            ...
            <button onClick={aumentar}> <i class="fa fa-plus" aria-hidden="true"></i> Aumentar</button>
            <button onClick={disminuir}> <i class="fa fa-minus" aria-hidden="true"></i> Disminuir</button>
        </div>
    )
}